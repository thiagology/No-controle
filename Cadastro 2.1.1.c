			 	...
			 	int contador_arc = contador_arc + 0;
			 		...
			 		do
			 		{
			 			...
			 			switch(menu)
			 			{
			 				...
			 				case '2':
			 					printf("\n1-Para exibir todo o estoque\n2-Para buscar ID do produto\n3-Buscar produto pelo nome");
			 					scanf("%d", &menu2);
			 					...
			 					switch(menu2)
			 					{
			 						case '1':
			 							...
			 							{
			 								printf("\n\n\nNome do produto: %s\nID: %i\nTipo: %s\nPreço: %f\nValidade: %s\nQuantidade: %i\n\n", produtos[j].nome, produtos[j].ID, produtos[j].tipo, produtos[j].preco, produtos[j].validade, produtos[j].quantidade);		
										 };
										 break;
									case '2':
										break;
